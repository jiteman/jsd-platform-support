...
// detect ILP32
#if JSD_ARCHITECTURE_TYPE == JSD_ARCHITECTURE_TYPE_INTEL_X86 && defined( JSD_GNU_CCPP_COMPILER_IS_DETECTED ) || \
	JSD_ARCHITECTURE_TYPE == JSD_ARCHITECTURE_TYPE_INTEL_X86 && defined( JSD_MICROSOFT_VISUAL_CPP_COMPILER_IS_DETECTED )

	#define JSD_MEMORY_MODEL_IS_ILP32				JSD_CPP_TRUE
	#define JSD_MEMORY_MODEL_ILP32_IS_DEFINED		JSD_CPP_TRUE
...
#else
	#define JSD_MEMORY_MODEL_ILP32_IS_DEFINED		JSD_CPP_FALSE
