...
#include "jmsd/platform_support/common_preprocessor_constants.h"
...
#if JSD_ARCHITECTURE_TYPE == JSD_ARCHITECTURE_TYPE_AMD64 && defined( JSD_GNU_CCPP_COMPILER_IS_DETECTED )

	#define JSD_MEMORY_MODEL_IS_LP64				JSD_CPP_TRUE
	#define JSD_MEMORY_MODEL_LP64_IS_DEFINED		JSD_CPP_TRUE
	...
	namespace memory_models {
		...
		typedef signed long integer_8_bytes_type;

		// Long_natural, Natural_64_bits, Natural_8_bytes
		typedef unsigned long natural_8_bytes_type;
...
#else
	#define JSD_MEMORY_MODEL_LP64_IS_DEFINED		JSD_CPP_FALSE
